...
import { buildPortraitRequest } from '../src/lib/portrait.ts';
...
test('exposes only the compatible model assets and zimage LoRAs', async () => {
  const replies = [
    nodeInfo('UNETLoader', 'unet_name', ['z_image_turbo_int8_convrot.safetensors']),
    nodeInfo('CLIPLoader', 'clip_name', ['qwen_3_4b.safetensors']),
    nodeInfo('VAELoader', 'vae_name', ['ae.safetensors']),
